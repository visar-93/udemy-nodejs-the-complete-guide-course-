...
exports.getProducts = (req, res, next) => {
  ...
  const page = +req.query.page || 1; // if req.query.page is undefined or nullish value, instead of that page will be equal to one
  let totalItems;
  ...
  Order.findById(orderId)
    .then((order) => {
      ...
      pdfDoc
        .fontSize(22)
        .fillColor("red")
        .text(`Total Order: $ ${order.totalOrder}`, {
          align: "right",
          underline: true,
        });
